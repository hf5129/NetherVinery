...
public class NetherDrinkBlockItem extends BlockItem {
    private final int baseDuration;
    private final boolean scaleDurationWithAge;

    public NetherDrinkBlockItem(Block block, Properties settings, int baseDuration, boolean scaleDurationWithAge) {
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos blockPos, Level level, @Nullable Player player, ItemStack itemStack, BlockState blockState) {
        if(level.getBlockEntity(blockPos) instanceof NetherStorageBlockEntity wineEntity){

...
public class NetherObjectRegistry {
    ...
    public static final RegistrySupplier<Item> IMPROVED_LAVA_FIZZ_ITEM = registerFixedDurationWineItem("improved_lava_fizz", IMPROVED_LAVA_FIZZ, 30, () -> NetherEffects.IMPROVED_GRAVEDIGGER.get(), 0);
    ...
    public static <T extends Item> RegistrySupplier<T> registerItemtem(String path, Supplier<T> itemSupplier) {
        return GeneralUtil.registerItem(ITEMS, ITEM_REGISTRAR, new NetherVineryIdentifier(path), itemSupplier);
    }
}
